  ...
  return (
    <div className="max-w-lg mx-auto px-4">
      <div className="bg-white shadow rounded-lg px-10 py-8 mt-16">
          ...
          <h2 className="text-gray-700 mb-8 text-center">
          ...
          <a
            href="#"
            className="text-blue-700 hover:text-blue-800 mb-4 inline-block text-sm mt-1.5"
          >
            Forgot your password?
          </a>
          <button className="shadow-sm mt-5 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded w-full focus:outline-none focus:shadow-outline transition-all duration-200" >
            Login
          </button>
